...
import {
  MapPin, Calendar, ChevronRight, Edit, Settings, LogOut,
  Mail, Globe, Search, Briefcase
} from 'lucide-react';
...
function App() {
  ...
  const photo = localStorage.getItem("photo") || "assets/images/icon123.jpg";
  const user = JSON.parse(localStorage.getItem("Freelancer"));
  ...
  useEffect(() => {
    axios.get('http://localhost:8081/Freelancers')
      .then(response => {
    ...
    <div>
      <header className="header1">
        <div className="header-content1">
          <nav className="nav1">
            <a href="/" className="nav-link active1">Home</a>
      ...
      >
        Delete picture
              ...
              <h2 className="profile-name1">
                {Freelancer ? `${Freelancer.first_name} ${Freelancer.last_name}` : "name user"}
              </h2>

              <div className="profile-details1">
                <div className="profile-detail1">
                  <Mail size={16} />
                  <span>{Freelancer ?Freelancer.email : "Email"}</span>
                </div>
                <div className="profile-detail1">
                  <Briefcase size={16} />
                  <span>{Freelancer ? Freelancer. skill: " skill"}</span>
                </div>
                <div className="profile-detail1">
                  <Globe size={16} />
                  <span>{Freelancer ? Freelancer.Country : "Country"}</span>
                </div>
                ...
                <div className="freelancer-card1">
                  <div className="freelancer-header1">
                    ...
                    <div className="freelancer-info1">
                      ...
                      <div className="freelancer-specialty1">
                        <Briefcase size={14} />
                        <span>Specialty: React, Node.js</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="freelancer-card1">
                  <div className="freelancer-header1">
                    ...
                    <div className="freelancer-info1">
                      ...
                      <div className="freelancer-specialty1">
                        <Briefcase size={14} />
                        <span>Specialty: Figma, Adobe XD</span>
                      </div>
                    </div>
                  </div>
                  <div className="freelancer-stats1">
